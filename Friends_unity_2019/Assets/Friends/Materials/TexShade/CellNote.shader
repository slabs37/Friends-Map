        ...
        */
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 edges = pow(dot(i.localPos, i.normal) + 0.7, 16);
                float3 lightColor = Color;

                float NdotL = dot(worldNormal, edges);
                ...
                float3 litColor = Color * litFactor;
                float3 finalColor = litColor + ambient + rim;
