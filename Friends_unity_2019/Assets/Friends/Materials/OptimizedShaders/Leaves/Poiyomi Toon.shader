Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/cd649034bf752a145b3bea4246a4a1f2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (5.0 /*_SSSSpread*/)) * (0.25 /*_SSSStrength*/);
				...
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0.1603774,0.1214064,0,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0.1603774,0.1214064,0,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0.5294118,0.06154528,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,0.5294118,0.06154528,1).a;
